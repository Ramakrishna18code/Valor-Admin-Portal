...
export const schemas = {
 buildings: [id('customerProfileId','Customer profile ID'),field('buildingName','Building name','text',true,200),field('buildingType','Building type','text',false,80),field('address','Address','text',false,500),field('city','City','text',false,100),field('state','State','text',false,100),field('pincode','Pincode','text',false,20),field('emergencyContactName','Emergency contact name','text',false,160),field('emergencyContactPhone','Emergency contact phone','text',false,20),{...field('buildingPreference','Building preference','select',false,20),options:['MAIN','SECONDARY','OTHER']},field('status','Status (defaults to ACTIVE)','text',false,20)],
